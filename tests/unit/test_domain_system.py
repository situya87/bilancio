...
def test_create_agents_and_deposit_invariants():
    ...
    d = BankDeposit(id="D1", kind=InstrumentKind.BANK_DEPOSIT, amount=100, denom="X",
...
def test_policy_allows_and_blocks_expected_cases():
    ...
    sys.add_contract(BankDeposit(id="d", kind=InstrumentKind.BANK_DEPOSIT, amount=10, denom="X",
                                 asset_holder_id="H1", liability_issuer_id="B1"))
    ...
    sys.add_contract(Payable(id="p", kind=InstrumentKind.PAYABLE, amount=7, denom="X",
